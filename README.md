...
CSE0001 Digital Literacy Project – Infographic, Portfolio, Coding Practice, Collaboration Tools, Email Etiquette, and Cybercrime Awareness tasks with reflections and screenshots.
# CSE0001 Digital Literacy Project

This repository contains my coursework submissions for the **Digital Literacy Project**.  
It includes tasks on infographic design, portfolio creation, coding practice, and collaboration tools.  
Each task folder has supporting files, screenshots, and reflections.
